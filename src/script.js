...
// Adding voice command to search weather of specific city
...
async function checkWeather(city) {
  ...
  if (response.status == 404) {
    ...
    // Play the sound for incorrect city
    audio.src = "/wrongCity.mp3"; 
     audio.play();
    console.log("Playing sound for incorrect city");
  } else {
